...
// MQTT
const char* mqtt_server = "192.168.0.101";  // IP of the MQTT broker
const char* Picc_data = "picc/data";
const char* mqtt_username = "esp"; // MQTT username
const char* mqtt_password = "esp"; // MQTT password
const char* clientID = "client_esp"; // MQTT client ID
